...
| `tunnels` (no args) | Interactive picker: pick an account, then a target or `all`, and start it. `/` filters the list as you type, `←`/`b`/`q` step back to the account list, ctrl-c quits |
